...
//        var roleidD = $("#roleidD").val();//删除-角色ID
//        var rolenameD = $("#rolename").val();//删除-角色名称
//        var server = $(".right_content9 input");
//    //  console.log(server)
//        for(var i = 0;i<server.length;i++){
//        	if(server[i].checked == true){
//        		serverChoose=server[i].value
	...
	$.ajax({
		...
		success:function(json){
			for(var i = 0;i<json.rows.length;i++){
				...
				$(".left_content1").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs1(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content2").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs2(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content3").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs3(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content4").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs4(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content5").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs5(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content6").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs6(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
				$(".left_content7").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs7(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
                $(".left_content8").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs8(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
                $(".left_content9").append("<div><input type='checkbox' value="+json.rows[i].areaId+" onclick='checboxs9(this)' />"+"<span>"+json.rows[i].areaName+"</span></div>");
			}
...
function checboxs1(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content1 input").eq(0).val();
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content1").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
	}
	if($(obj).is(":checked") == true){
		 for(var i=0;i<($(".left_content1 input").length);i++){
	            $(".left_content1 input").eq(i).prop("checked", false)
	        }
	    $(obj)[0].checked=true
		$(".right_content1").empty();
		areaid = $(obj).val();
...
function select2(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content2").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content2 input").length);i++){
            $(".left_content2 input").eq(i).prop("checked", false)
		}
		$(".left_content2 input").eq(0).prop("checked", true)
		$(".right_content2 input").eq(0).prop("checked", true).siblings().prop("checked", false);
	}
}
function checboxs2(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content2 input").eq(0).val();
		$(".right_content2").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select3(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content3").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content3 input").length);i++){
            $(".left_content3 input").eq(i).prop("checked", false)
		}
		$(".left_content3 input").eq(0).prop("checked", true)
		$(".right_content3 input").eq(0).prop("checked", true).siblings().prop("checked", false);}
}
function checboxs3(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content3 input").eq(0).val();
		$(".right_content3").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select4(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content4").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content4 input").length);i++){
            $(".left_content4 input").eq(i).prop("checked", false)
		}
		$(".left_content4 input").eq(0).prop("checked", true)
		$(".right_content4 input").eq(0).prop("checked", true).siblings().prop("checked", false);
	}
}
function checboxs4(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content4 input").eq(0).val();
		$(".right_content1").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select8(ob){
    ...
    if(value == 0){
        ...
        $.ajax({
            ...
            success:function(json){
                for(var i = 0;i<json.rows.length;i++){
                    $(".right_content8").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
                }
            }
        });
        ...
        for(var i=0;i<($(".left_content8 input").length);i++){
            $(".left_content8 input").eq(i).prop("checked", false)
		}
		$(".left_content8 input").eq(0).prop("checked", true)
		$(".right_content8 input").eq(0).prop("checked", true).siblings().prop("checked", false);
    }
}
function checboxs8(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content8 input").eq(0).val();
		$(".right_content8").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select9(ob){
    ...
    if(value == 0){
        ...
        $.ajax({
            ...
            success:function(json){
                for(var i = 0;i<json.rows.length;i++){
                    $(".right_content9").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
                }
            }
        });
        $(".left_content9 input").prop("disabled",true);
        $(".right_content9 input").prop("disabled",true);
        $(".left_content9 input").prop("checked",true);
        $(".right_content9 input").prop("checked",true);
    }else{
        $(".right_content9").empty();
        var areaid = $(".left_content9 input").eq(0).val();
        $.ajax({
            type:"get",
            url:"../getServerListNoPage.action",
            async:true,
        ...
        $(".left_content9 input").prop("disabled",false);
        $(".right_content9 input").prop("disabled",false);
        for(var i=0;i<($(".left_content9 input").length);i++){
            $(".left_content9 input").eq(i).prop("checked", false)
		}
		$(".left_content9 input").eq(0).prop("checked", true)
		$(".right_content9 input").eq(0).prop("checked", true).siblings().prop("checked", false);
    }
}
function checboxs9(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content9 input").eq(0).val();
		$(".right_content9").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select5(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content5").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content5 input").length);i++){
            $(".left_content5 input").eq(i).prop("checked", false)
		}
		$(".left_content5 input").eq(0).prop("checked", true)
		$(".right_content5 input").eq(0).prop("checked", true).siblings().prop("checked", false);
	}
}
function checboxs5(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content5 input").eq(0).val();
		$(".right_content5").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select6(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content6").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content6 input").length);i++){
            $(".left_content6 input").eq(i).prop("checked", false)
		}
		$(".left_content6 input").eq(0).prop("checked", true)
		$(".right_content6 input").eq(0).prop("checked", true).siblings().prop("checked", false);
	}
}
function checboxs6(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content6 input").eq(0).val();
		$(".right_content6").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
...
function select7(ob){
	...
	if(value == 0){
		...
		$.ajax({
			...
			success:function(json){
				for(var i = 0;i<json.rows.length;i++){
					$(".right_content7").append("<div><input type='checkbox' checked='checked' value="+json.rows[i].serverId+" />"+"<span>"+json.rows[i].serverName+"</span></div>");
				}
			}
		});
		...
		for(var i=0;i<($(".left_content7 input").length);i++){
            $(".left_content7 input").eq(i).prop("checked", false)
		}
		$(".left_content7 input").eq(0).prop("checked", true)
		$(".right_content7 input").eq(0).prop("checked", true).siblings().prop("checked", false);
	}
}
function checboxs7(obj){
	var areaid
	if(obj == undefined){
		areaid = $(".left_content7 input").eq(0).val();
		$(".right_content7").empty();
		$.ajax({
			type:"get",
			url:"../getServerListNoPage.action",
